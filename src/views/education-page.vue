<template>
  <div id="education" class="pt-16">
    <v-row class="pb-0 mt-4" justify="center">
      <p class="titl grey--text text--darken-2">EDUCATION</p>
    </v-row>
    ...
    <v-layout
      ...
      "
    >
      <v-flex xs11 sm11 md6 lg6 xl4 class="mb-4">
        <div class="colname">{{ edu.name }}</div>
        <div class="mt-1" style="font-size: 22px; color: #555555">
          {{ edu.det }}
        </div>
        <div class="mt-2" style="font-size: 20px; color: #555555">
          {{ edu.loc }}
        </div>
        <div
          v-if="edu.gpa != ''"
      ...
      edus: [
        {
          ...
          det: "Masters of Science in Computer Science",
        ...
        },
        {
          ...
          det: "Bachelor of Technology in Computer Science and Engineering",
