          ...
          <div class="">
            <v-tooltip top>
              <template v-slot:activator="{ on, attrs }">
                <a
                  ...
                  v-on="on"
                  v-bind="attrs"
                  href="https://www.linkedin.com/in/prashanthannam/"
                  target="_blank"
                  ><v-icon class="belowIc" large color=""
                    >mdi-linkedin</v-icon
                  ></a
                >
              </template>
            ...
            <v-tooltip top>
              <template v-slot:activator="{ on, attrs }">
                <a
                  ...
                  v-on="on"
                  v-bind="attrs"
                  href="https://github.com/prashanthannam"
                  target="_blank"
                >
                  <v-icon class="belowIc" large color="">mdi-github</v-icon>
                </a></template
              >
              <span>GitHub</span>
            </v-tooltip>
            <v-tooltip top>
              <template v-slot:activator="{ on, attrs }">
                ...
                >
                  <v-icon class="belowIc" large color="">mdi-file</v-icon></a
                >
              </template>
              <span>My Resume</span>
            </v-tooltip>
            <v-tooltip top="">
              <template v-slot:activator="{ on, attrs }">
                <a
                  ...
                  v-on="on"
                  v-bind="attrs"
                  href="https://mail.google.com/mail/?view=cm&fs=1&to=prashanth31399@gmail.com"
                  target="_blank"
                  ><v-icon class="belowIc" large color="">mdi-email</v-icon></a
                >
              </template>
              <span>Mail me</span>
            </v-tooltip>
        ...
        <v-card-text class="pt-2 pb-2">
          <v-layout row wrap justify-center>
            <v-flex xs4 sm4 md4 lg4 xl4 class="text-center">
              <p class="mt-1 mb-1">
                Prashanth <v-icon small="">mdi-copyright</v-icon> 2020
              </p>
            </v-flex>
          </v-layout>
        </v-card-text>
...
export default {
  ...
  data() {
    return {
      nav: false,
      items: [
        { icon: "mdi-home", title: "Home", route: "#main" },
        { icon: "mdi-account", title: "About", route: "#about" },
        { icon: "mdi-briefcase", title: "Portfolio", route: "#projects" },
        { icon: "mdi-phone", title: "Contact", route: "#contact" },
      ],
    };
  },
};
